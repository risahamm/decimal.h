...
Реализация собственной библиотеки s21_decimal.h. Учебный проект.
...
- Подготовлено полное покрытие unit-тестами функций библиотеки c помощью библиотеки <check.h>
